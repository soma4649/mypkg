...
[![test](https://github.com/soma4649/mypkg/actions/workflows/test.yml/badge.svg?branch=success)](https://github.com/soma4649/mypkg/actions/workflows/test.yml)


2023年度千葉工業大学ロボットシステム学講義内での課題提出用リポジトリです。


このリポジトリでは、talkerとlistenerという二つのノード間でROS2のフレームワークを使って、パブリッシュ/サブスクライブ通信を行います。
